    ...
    const editarProduto = async () => {
        try {
            ...
            await updateDoc(produtoRef, {
                ...
                IPI: ipiEditado,
                PRECO_IPI: parseFloat(precoEditado) + (parseFloat(precoEditado)*(parseFloat(ipiEditado)/100)),
                ICMS: icmsEditado,
                PRECO_ICMS: parseFloat(precoEditado) + (parseFloat(precoEditado)*(parseFloat(icmsEditado)/100)),
                PRECO_FINAL: (parseFloat(precoEditado)*(parseFloat(ipiEditado)/100)) + (parseFloat(precoEditado)*(parseFloat(icmsEditado)/100)) + parseFloat(precoEditado),
